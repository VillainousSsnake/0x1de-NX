...
eventsListGlobal = """{
    "Trigger": [
        ...
        "FireExtinguish",
        "GrabDelete",
        "StartFeedbackControl",
        "ParameterChange",
        "SheikahStoneGrab",
        "SheikahStonePut",
        "SheikahStoneGrabWaist",
        "SheikahStoneReturnWaist",
        "ResetBoneControl",
        "ResetWeatherChangedFlag",
        "ChangeSignal",
        "Flap",
        "UpdateHeartGauge",
        "Show",
        "RumbleControllerTrigger",
        "CameraReset",
        "FadeStart",
        "PlayerFace",
        "SpurKick",
        ...
        "SheikahStoneGrabWaistRight",
        "ClimbEnd",
        "DecideAttackPos",
        "RequestZonauMaterial",
        "ActivateArmorAbility",
        "ChangableSprain",
        "DungeonGoronBossRestoreRLeg",
        "DungeonGoronBossRestoreLLeg",
        "SwordCancelStart"
    ],
    "Hold": [
        "AtCollision",
        ...
        "WeaponBreakFinish",
        "NoLegBendOnHorse",
        "ChangeSeFloorContact",
        "PreAttack",
        "ReleaseWeapon",
        "RumbleControllerHold",
        "HeadEquipNoDisplay",
        "ChangeForm",
        "RemovePartial",
        "FloorContact",
        ...
        "NoSpurs",
        "BurstPeriod",
        "DungeonBossZoraFinVisible",
        "DungeonBossZoraSharkFinVisible",
        "LimitLookIK",
        "Dodge",
        "GetOffBack",
        "OverrideReaction",
        "NoWeaponAbility",
        "InvalidAutoHeadLookIK",
        "BowCharge",
        "Rolling",
        "WeaponInvisible",
        "YunboAccessoryVisible",
        "MogurudoWaitEating",
        "DungeonBossGoronBreakableRoot",
        "ZonauGolemEyeLightOn",
        "MogurudoVacuum",
        "ZonauGolemEnableZonauParts",
        "Showing",
        "FixPlayerLookPos",
        "ForbidRagdoll",
        "DrakeDisableTailRagdoll",
        "ChangeGlideAnm",
        "DisableHandIK",
        "InvalidChangeGlideAnm",
        "AttachmentVisibleOn",
        "Spraining",
        "DisableBoneModifier",
        "ForbidJustAvoid",
        ...
        "FittingModelToSlope",
        "HasToSyncRiderAnm",
        "DisableAIScheduleLOD",
        "NoBlinkChangeFaceEmotion",
        "DisableGuard",
        "LookIKReturn",
        "GuardBreak",
        "FootIK",
...
class BAEV:
    def __init__(self, data, filename, stream=ReadStream(b''), string_pool=ReadStream(b'')):
        ...
        self.event_list = json.loads(eventsListGlobal)
